...
if ( !isset( $_SESSION['isLoggedIn'] ) ) {
    ...
    <form id="articles" class="articles" method="get">
        <select id="management_category" onchange="window.location='?panel=management&section=articles&category=' + this.value;" style="font-size: 1.2em; width: 75%; display: block; margin-left: auto; margin-right: auto; padding: 10px;">
